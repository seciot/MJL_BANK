...
// StyleSheet
#define BTN_BLUE_STYLE " QPushButton {color: rgb(255, 255, 255);	background-color: rgba(0, 153, 255, 70%);border-radius: 6px;}  QPushButton:pressed {color: rgb(255, 255, 255);	background-color: rgba(0, 153, 255, 100%); border-radius: 6px;}"
#define BTN_GREEN_STYLE " QPushButton {color: rgb(0, 0, 0);	background-color: rgba(0, 255, 0, 70%); border-radius: 6px;}  QPushButton:pressed {color: rgb(0, 0, 0);	background-color: rgba(0, 255, 0, 100%); border-radius: 6px;}"
#define BTN_GREY_STYLE "QPushButton {color: rgb(255, 255, 255);	background-color: rgba(139,139,122,70%);border-radius: 6px;}  QPushButton:pressed {color: rgb(0, 0, 0);	background-color: rgba(139,139,122, 100%);border-radius: 6px;}"
