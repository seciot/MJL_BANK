#ifndef UICASHDEPOSIT_H_
#define UICASHDEPOSIT_H_
#include "ui.h"
#include <QAction>
#include <QThread>
...
class UICashDeposit : public QDialog
{
    Q_OBJECT
public:
    explicit UICashDeposit(QDialog *parent = 0,Qt::WindowFlags f = Qt::FramelessWindowHint);
    ~UICashDeposit();
